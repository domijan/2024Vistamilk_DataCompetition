...
## RMSE: regression (validation set 24 samples)
...
## RMSE: classification (validation set 24 samples)
...
## Results: testing set lactose content received after submission
...
## Testing set data: medoids for each sample
...
## LDA subspace (testing set samples with lactose content 24 and 60)
...
## RF variable importance subspace: training and testing data (samples with lactose content 24 and 60)
