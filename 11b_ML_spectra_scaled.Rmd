...
train_data <- specTrain|> select(c(`412.71`: `3907.24`))



mn <- apply(train_data, 2, mean)
sd <- apply(train_data, 2, sd)

train_data <- sweep(train_data,2, mn, "-")
train_data <- sweep(train_data,2, sd, "/")
# 
# sum(specTrain|> select(c(`412.71`: `3907.24`)) !=specTrain[,1:1813])

  
  
specTrain[,1:1813]  <- train_data
