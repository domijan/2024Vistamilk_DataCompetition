...
set.seed(1951)
 ...
 pred_table <- tibble(pred = as.numeric(lasso.pred)) |> mutate(samp = te.samp) |> group_by(samp) |> summarise(mn.pred = median(pred)) |> left_join(truth)
...
saveRDS(RMSE, "RMSEreg2.rds")

saveRDS(preds, "pred_tablereg2.rds")
